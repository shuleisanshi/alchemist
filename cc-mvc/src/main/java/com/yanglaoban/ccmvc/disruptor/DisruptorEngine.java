...
import com.yanglaoban.ccmvc.config.CcMvcProperty;
import com.youngboss.ccutil.reflect.TypeUtil;
...
import static com.yanglaoban.ccmvc.disruptor.DisruptorUtil.createDisruptor;
import static com.yanglaoban.ccmvc.disruptor.DisruptorUtil.shutDownDisruptor;
...
public class DisruptorEngine implements InitializingBean, ApplicationListener<ContextClosedEvent> {
	...
	public DisruptorEngine(CcMvcProperty.Disruptor disruptorProperty) {
	...
	public void afterPropertiesSet() {
		...
		disruptor = createDisruptor(DisruptorEvent::new, 1 << power);
